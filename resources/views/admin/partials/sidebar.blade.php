<div class="flex flex-col h-full">
    ...
    <div class="flex-1 overflow-y-auto py-4 px-3 space-y-0.5">
        ...
        <a href="{{ route('admin.order.index') }}" class="flex items-center space-x-3 px-3 py-2 text-sm font-medium transition border-l-2 {{ request()->routeIs('admin.order*') ? 'border-indigo-600 text-indigo-600' : 'border-transparent text-gray-500 hover:text-gray-900 hover:border-gray-300' }}">
        ...
        <a href="{{ route('admin.user.index') }}" class="flex items-center space-x-3 px-3 py-2 text-sm font-medium transition border-l-2 {{ request()->routeIs('admin.user*') ? 'border-indigo-600 text-indigo-600' : 'border-transparent text-gray-500 hover:text-gray-900 hover:border-gray-300' }}">
            <i class="fas fa-users w-4 text-center"></i>
            <span>Users</span>
        </a>

        <a href="{{ route('admin.setting.index') }}" class="flex items-center space-x-3 px-3 py-2 text-sm font-medium transition border-l-2 {{ request()->routeIs('admin.setting*') ? 'border-indigo-600 text-indigo-600' : 'border-transparent text-gray-500 hover:text-gray-900 hover:border-gray-300' }}">
