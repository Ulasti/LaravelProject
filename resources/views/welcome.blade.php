...
@section('content')
    ...
    <section class="py-16">
        ...
        <div class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-6">
            <div class="p-8 bg-white border border-gray-100 text-center cursor-pointer">
    ...
    <section class="py-16 border-t border-gray-100">
        ...
        <div class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-6">
            @for ($i = 0; $i < 4; $i++)
                <div class="bg-white border border-gray-100 overflow-hidden cursor-pointer">
    ...
    <section class="py-16">
        <div class="bg-gradient-to-r from-indigo-600 to-purple-700 p-8 sm:p-12 text-center">
